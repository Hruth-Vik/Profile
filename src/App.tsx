...
import { ProjectCardSlider } from './components/mobile/ProjectCardSlider';
import { HorizontalScrollSection } from './components/desktop/HorizontalScrollSection';
        ...
        <>
            ...
            <div className={`min-h-screen transition-colors duration-700 font-sans selection:bg-pink-500 selection:text-white ${darkMode ? 'bg-black text-zinc-100' : 'bg-white text-zinc-900'}`}>
                ...
                <main className="relative z-10">
                    ...
                    {isMobile ? (
                        <ProjectCardSlider darkMode={darkMode} />
                    ) : (
                        <HorizontalScrollSection darkMode={darkMode} />
                    )}
